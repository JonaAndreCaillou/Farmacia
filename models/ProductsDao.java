...
public class ProductsDao {
    ...
    public boolean registerProductQuery(Products product) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "No se pudo registrar los datos del producto. " + e);
    ...
    //Modificar productos
    public boolean updateCategoryQuery(Products product) {
        String query = "UPDATE categories SET code = ?, name = ?, description = ?, unit_price = ?, updated = ?, category_id = ?"
                + ("WHERE id = ?");
    ...
    public boolean deleteProductQuery(int id){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "No puedes eliminar un producto que tenga relacion con otra tabla. " + e);
            return false;
        }
    ...
    //Traer stock de producto
    public Products searchId(int id){
        String query = "SELECT pro.product_quantity, pro.name, pro.unit_price FROM products pro WHERE pro.id = ?";
        Products product = new Products();
